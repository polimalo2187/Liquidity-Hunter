...
PREMIUM_PROFILE = {
    ...
    "min_sweep_atr": 0.16,
    "min_rel_volume": 1.22,
    "min_confirm_rel_volume": 0.90,
    "min_wick_body_ratio": 1.35,
    "min_wick_range_ratio": 0.38,
    "min_confirm_body_ratio": 0.26,
    "entry_offset_atr": 0.07,
    "sl_buffer_atr": 0.11,
    "min_rr": 1.55,
    "min_barrier_rr": 0.95,
    "ema_reclaim_buffer_atr": 0.04,
    "max_countertrend_atr": 0.32,
    "min_pivots": 2,
    "min_sweep_range_atr": 0.75,
    "max_sweep_range_atr": 2.60,
    "max_risk_pct": 0.0095,
    "components": [
        "liquidity_zone",
        "minimum_sweep",
...
PLUS_PROFILE = {
    ...
    "min_sweep_atr": 0.12,
    "min_rel_volume": 1.08,
    "min_confirm_rel_volume": 0.80,
    "min_wick_body_ratio": 1.10,
    "min_wick_range_ratio": 0.32,
    "min_confirm_body_ratio": 0.20,
    "entry_offset_atr": 0.09,
    "sl_buffer_atr": 0.13,
    "min_rr": 1.40,
    "min_barrier_rr": 0.85,
    "ema_reclaim_buffer_atr": 0.02,
    "max_countertrend_atr": 0.45,
    "min_pivots": 2,
    "min_sweep_range_atr": 0.60,
    "max_sweep_range_atr": 2.90,
    "max_risk_pct": 0.0115,
    "components": [
        "liquidity_zone",
        "minimum_sweep",
...
FREE_PROFILE = {
    ...
    "min_sweep_atr": 0.08,
    "min_rel_volume": 0.95,
    "min_confirm_rel_volume": 0.72,
    "min_wick_body_ratio": 0.90,
    "min_wick_range_ratio": 0.27,
    "min_confirm_body_ratio": 0.15,
    "entry_offset_atr": 0.10,
    "sl_buffer_atr": 0.15,
    "min_rr": 1.28,
    "min_barrier_rr": 0.75,
    "ema_reclaim_buffer_atr": 0.00,
    "max_countertrend_atr": 0.58,
    "min_pivots": 2,
    "min_sweep_range_atr": 0.50,
    "max_sweep_range_atr": 3.20,
    "max_risk_pct": 0.0130,
    "components": [
        "liquidity_zone",
        "minimum_sweep",
...
def _confirmation_candle_ok(confirm_candle: pd.Series, sweep_candle: pd.Series, direction: str, profile: Dict) -> bool:
    ...
    hybrid_ok = rel_volume >= min_rel_volume and body_ratio >= max(0.12, min_body_ratio * 0.75)
...
def _higher_timeframe_context_ok(df_1h: pd.DataFrame, direction: str, profile: Dict) -> bool:
    ...
    if direction == "LONG":
        ...
        if close < ema50 - (countertrend * 1.40) and heavy_bearish_bias:
            return False
        if close < ema20 - (countertrend * 1.80) and slope20 < 0:
            return False
        return True

    heavy_bullish_bias = ema20 > ema50 and slope20 > 0
    if close > ema50 + (countertrend * 1.40) and heavy_bullish_bias:
        return False
    if close > ema20 + (countertrend * 1.80) and slope20 > 0:
        return False
    return True
